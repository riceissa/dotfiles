...
sudo apt install python3-typer yt-dlp urlwatch python3-html2text python3-bs4 python3-mypy python3-dateutil python3-oauth2client python3-googleapi python3-yaml python3-minidb python3-requests python3-keyring python3-appdirs python3-lxml python3-cssselect
