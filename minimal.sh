...
cat <<'EOF' > ~/.vim/autoload/pathogen.vim
...
cd ~/.vim/bundle && git clone https://github.com/riceissa/vim-rsi.git
cd ~/.vim/bundle && git clone https://github.com/tpope/vim-commentary.git
cd ~/.vim/bundle && git clone https://github.com/tpope/vim-eunuch.git
...
cd ~/.vim/bundle && git clone https://github.com/tpope/vim-unimpaired.git
